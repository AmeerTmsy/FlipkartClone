            ...
            <div className='section11'>
                ...
                <Link className='section11link' to='/'>
                    <div className='section11LinkDivsectionof1'>
                        ...
                        <span>
                            <span>Fashion <i className="ri-arrow-down-s-line sction1LinkSpan"></i></span>
                        </span>
                    </div>
                </Link>
                <Link className='section11link' to='/'>
                    <div className='section11LinkDivsectionof1'>
                        ...
                        <span>
                            <span>Electronics<i className="ri-arrow-down-s-line sction1LinkSpan"></i></span>
                        </span>
                    </div>
                </Link>
                <Link className='section11link' to='/'>
                    <div className='section11LinkDivsectionof1'>
                        ...
                        <span>
                            <span>Home & Furniture<i className="ri-arrow-down-s-line sction1LinkSpan"></i></span>
                        </span>
                    </div>
                </Link>
                <Link className='section11link' to='/'>
                ...
                <Link className='section11link' to='/'>
                    <div className='section11LinkDivsectionof1'>
                        ...
                        <span>
                            <span>Beauty, Food.. <i className="ri-arrow-down-s-line sction1LinkSpan"></i></span>
                        </span>
                    </div>
                </Link>
                <Link className='section11link' to='/'>
